...
EventComponents EventComponentsToEventNameTable[E_Count] =
{
  /*{Transition Type, Transition Key, Before KeyFlags,         After KeyFlags,          Event Name,           Transition KeyCode, Before V, After V, Before B, After B, Event Index, },*/
	...
	{KeyIsDown,       KeyFlag_K,      (KeyFlag_None),          (KeyFlag_K),             E_KDown_From___To_K_, kVK_ANSI_K,         "▆▆▆",    "▆▃▆",   0b000,    0b010,   5,           },
	{KeyIsUp,         KeyFlag_L,      (KeyFlag_K | KeyFlag_L), (KeyFlag_K),             E_LUp_From_KLTo_K_,   kVK_ANSI_L,         "▆▃▃",    "▆▃▆",   0b011,    0b010,   6,           },
	{KeyIsDown,       KeyFlag_L,      (KeyFlag_K),             (KeyFlag_K | KeyFlag_L), E_LDown_From_K_To_KL, kVK_ANSI_L,         "▆▃▆",    "▆▃▃",   0b010,    0b011,   7,           },
	{KeyIsUp,         KeyFlag_K,      (KeyFlag_K | KeyFlag_L), (KeyFlag_L),             E_KUp_From_KLTo__L,   kVK_ANSI_K,         "▆▃▃",    "▆▆▃",   0b011,    0b001,   9,           },
	{KeyIsDown,       KeyFlag_L,      (KeyFlag_None),          (KeyFlag_L),             E_LDown_From___To__L, kVK_ANSI_L,         "▆▆▆",    "▆▆▃",   0b000,    0b001,   10,          },
};
